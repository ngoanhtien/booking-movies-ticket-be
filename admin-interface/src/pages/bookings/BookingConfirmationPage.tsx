    ...
    return (
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Alert severity="error">
          Không tìm thấy thông tin đặt vé. Vui lòng quay lại trang chi tiết phim.
        </Alert>
        <Button 
          ...
          <Paper sx={{ p: 3, width: '100%', mb: 4 }}>
            {loading ? (
              ...
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Grid container spacing={2} sx={{ textAlign: 'left', mb: 4 }}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle1" fontWeight="bold">Phim:</Typography>
                    <Typography variant="body1" sx={{ mb: 1 }}>
                      {bookingState.showtimeInfo.movieName}
                    </Typography>
                    
                    <Typography variant="subtitle1" fontWeight="bold">Rạp chiếu:</Typography>
                    <Typography variant="body1" sx={{ mb: 1 }}>
                      {bookingState.showtimeInfo.branchName}
                    </Typography>
                    
                    <Typography variant="subtitle1" fontWeight="bold">Phòng chiếu:</Typography>
                    <Typography variant="body1" sx={{ mb: 1 }}>
                      {bookingState.showtimeInfo.roomName}
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle1" fontWeight="bold">Suất chiếu:</Typography>
                    <Typography variant="body1" sx={{ mb: 1 }}>
                      {bookingState.showtimeInfo.scheduleTime} - {bookingState.showtimeInfo.scheduleDate}
                    </Typography>
                    
                    <Typography variant="subtitle1" fontWeight="bold">Ghế:</Typography>
                    <Typography variant="body1" sx={{ mb: 1 }}>
              ...
              <Box>
                ...
                <Grid container spacing={3} sx={{ mb: 3 }}>
                  <Grid item xs={12} sm={6}>
                    <Paper elevation={0} sx={{ p: 2, bgcolor: alpha(theme.palette.primary.main, 0.05), borderRadius: 2 }}>
                      ...
                      <Typography variant="body1" sx={{ mb: 1 }}>
                        <strong>Phim:</strong> {bookingState.showtimeInfo.movieName}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Thời gian:</strong> {bookingState.showtimeInfo.scheduleTime}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Ngày:</strong> {bookingState.showtimeInfo.scheduleDate}
                      </Typography>
                    </Paper>
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <Paper elevation={0} sx={{ p: 2, bgcolor: alpha(theme.palette.secondary.main, 0.05), borderRadius: 2 }}>
                      <Typography variant="subtitle1" gutterBottom fontWeight="bold">
                        Thông tin rạp
                      </Typography>
                      <Typography variant="body1" sx={{ mb: 1 }}>
                        <strong>Rạp:</strong> {bookingState.showtimeInfo.branchName}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Phòng:</strong> {bookingState.showtimeInfo.roomName}
                      </Typography>
                    </Paper>
                  </Grid>
                </Grid>
                ...
                {/* Seat Details */}
                <Paper elevation={0} sx={{ p: 2, mb: 3, bgcolor: alpha(theme.palette.success.main, 0.05), borderRadius: 2 }}>
                  <Typography variant="subtitle1" gutterBottom fontWeight="bold">
                    Thông tin ghế
                  </Typography>
                  <Typography variant="body1">
                    <strong>Số lượng ghế:</strong> {bookingState.selectedSeats.length}
                  </Typography>
                  <Typography variant="body1">
                    <strong>Ghế đã chọn:</strong> {bookingState.selectedSeats.join(', ')}
                  </Typography>
                </Paper>
                
                {/* Payment Details */}
                <Paper elevation={0} sx={{ p: 2, mb: 4, bgcolor: alpha(theme.palette.info.main, 0.05), borderRadius: 2 }}>
                  <Typography variant="subtitle1" gutterBottom fontWeight="bold">
